...
if __name__ == "__main__":
    ...
    # try:
    final_energy_df, emissions_df, capacity_df, layout_df = main(SINGLE_ECONOMY_ID='15_PHL')#'01_AUS')#'16_RUS')#economy)#'00_APEC')#economy)
    final_energy_df, emissions_df, capacity_df, layout_df = main(SINGLE_ECONOMY_ID='09_ROK')#'01_AUS')#'16_RUS')#economy)#'00_APEC')#economy)
    
    final_energy_df, emissions_df, capacity_df, layout_df = main(SINGLE_ECONOMY_ID='21_VN')#'01_AUS')#'16_RUS')#economy)#'00_APEC')#economy)
    
    final_energy_df, emissions_df, capacity_df, layout_df = main(SINGLE_ECONOMY_ID='02_BD')#'01_AUS')#'16_RUS')#economy)#'00_APEC')#economy)
